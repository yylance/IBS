   ...
   */
    ...
    function DataGrid(objName, tbName, id, isTreeGrid) {
        ...
        */
        ...
        this.ToolBar.BtnExportTemplate.isHidden = true;//DY 导出模板按钮默认为不显示2018.01.12
    };
    ...
    function regToolbarEvents(dg) {
        ...
        //打印
        toolbar.delegate("[flag = 'btn_print']", "click", function () {
            dg.ToolBar.BtnPrint.onExecute(dg);
        });
        ...
        //搜索区显隐切换-DY
        toolbar.delegate("[flag = 'btn_search_switch']", "click", function () {
            dg.ToolBar.BtnSearchSwitch.onExecute(dg);
        });
